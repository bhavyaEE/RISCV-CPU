...
Through this coursework, I thoroughly understood the structure and design to implement a RISC-V instruction set architecture and was able to apply the knowledge from the lectures in practice for the design. The key learning points for me were efficiently collaborating in a group, breaking down tasks to achieve the deliverables and developing better debugging skills: 
